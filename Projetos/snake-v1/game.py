...
# Aula 8 - Jogo da Cobrinha pt1 (24/03)
...
def reiniciar():
    ...
    x_cobra = ((largura_tela/2) - (80 / 2))
    y_cobra = ((altura_tela/2) - (60 / 2))
...
musica_background = pygame.mixer.music.load(
...
# Música para quando ouver colisão
musica_colisao = pygame.mixer.Sound('Projetos\\snake-v1\\sons\\smw_coin.wav')

# Vai fazer um barulho toda vez que juntar 10 pontos
musica_10pontos = pygame.mixer.Sound(
    'Projetos\\snake-v1\\sons\\smw_dragon_coin.wav')

# Definindo as variáveis para o tamanho da tela!
largura_tela = 640
altura_tela = 480
...
fundo_tela = (80, 60, 60)  # Cor de fundo da tela
